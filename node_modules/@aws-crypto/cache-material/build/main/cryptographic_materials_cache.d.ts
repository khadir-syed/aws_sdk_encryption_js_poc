...
export interface CryptographicMaterialsCache<S extends SupportedAlgorithmSuites> {
    putEncryptionMaterial(key: string, response: EncryptionMaterial<S>, plaintextLength: number, maxAge?: number): void;
    putDecryptionMaterial(key: string, response: DecryptionMaterial<S>, maxAge?: number): void;
...
//# sourceMappingURL=cryptographic_materials_cache.d.ts.map