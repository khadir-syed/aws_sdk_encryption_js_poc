...
EncryptedDataKey, WebCryptoAlgorithmSuite } from '@aws-crypto/material-management-browser';
...
export declare class RawAesKeyringWebCrypto extends KeyringWebCrypto {
    ...
    static importCryptoKey(masterKey: Uint8Array, wrappingSuite: WrappingSuiteIdentifier): Promise<CryptoKey>;
}
