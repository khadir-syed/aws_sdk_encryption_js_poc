...
export declare function randomValues(byteLength: number): Promise<Uint8Array>;
export declare function randomValuesOnly(byteLength: number): Promise<Uint8Array>;
